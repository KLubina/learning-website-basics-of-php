...
<body>
    ...
    <h2><a href="syntax.php">Syntax</a></h2>
    <ul>
    ...
    <h2><a href="variables.php">Variablen</a></h2>
    <ul>
    ...
    <h2><a href="data_structures.php">Datenstrukturen</a></h2>
    <ul>
    ...
    <h2><a href="control_structures.php">Kontrollstrukturen</a></h2>
    <ul>
    ...
    <h2><a href="functions.php">Funktionen</a></h2>
    <ul>
...
&lt;?php if ($_SERVER["REQUEST_METHOD"] == "POST") { echo "Hallo, " . $_POST["name"]; } ?&gt;</pre>
    ...
    <h2><a href="database_interaction.php">Datenbankinteraktion</a></h2>
    <ul>
...
foreach($pdo->query("SELECT * FROM tabelle") as the row) { print $row["spalte1"] . "&lt;br/&gt;"; } ?&gt;</pre>
    </ul>
</body>
</html>
